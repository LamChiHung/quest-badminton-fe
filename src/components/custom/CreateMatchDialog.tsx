...
export default function CreateMatchDialog({ tourId, roundId }: CreateGroupMatchDialogProps) {
        ...
        <div className="flex">
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                    <Button variant="outline" className="cursor-pointer"> <Plus />Thêm nhóm trận</Button>
                </DialogTrigger>
